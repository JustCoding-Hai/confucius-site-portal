                  ...
                  <section class="mt20">
                      <div class="lh-menu-wrap">
                          <menu id="lh-menu" class="lh-menu mt10 mr10">
                              <ul>
                                  <!-- 课程章节目录 -->
                                  <li v-for="chapter in course.chapterVOList" :key="chapter.id" class="lh-menu-stair">
                                      ...
                                      <ol class="lh-menu-ol" style="display: block;">
                                          <li v-for="video in chapter.children" :key="video.id" class="lh-menu-second ml30">
                                            ...
                                            <a v-else-if="video.free==true" :href="'/player/'+video.videoSourceId" 
                                                :title="video.title"
                                                target="_blank">
...
export default {
  ...
  created(){
      var token=cookie.get('confucius_jwt_token')
      if(token){
