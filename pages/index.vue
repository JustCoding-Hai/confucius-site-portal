      ...
      <div class="swiper-wrapper">
        <div 
          ...
          <a target="_blank" :href="topBannerAd.linkUrl">
            <img :src="topBannerAd.imageUrl" :alt="topBannerAd.tilte">
          </a>
        </div>
      </div>
...
export default {
  async asyncData(){
    ...
    const hotDataResponse=await indexApi.getHotData()
    const topBannerAdList=topBannerAdListResponse.data
    const courseList=hotDataResponse.data.courseList
    const teacherList=hotDataResponse.data.teacherList
    return {
      topBannerAdList,
      courseList,
      teacherList
